    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="card p-5 space-y-4">
          ...
          <div className="text-sm text-slate-400">{filtered.length} questions disponibles dans ce filtre.</div>
          <button className="btn-primary w-full" disabled={!filtered.length} onClick={start}>Démarrer</button>
        </div>
      </div>
    )
  }
