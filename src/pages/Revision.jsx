    ...
    return (
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        <div className="card p-5 space-y-4">
          ...
          <div className="text-sm text-slate-400">{queue.length} cartes prêtes.</div>
          <button className="btn-primary w-full" disabled={!queue.length} onClick={startSession}>
            {queue.length ? 'Démarrer la révision' : 'Aucune carte à réviser'}
          </button>
        </div>
