...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      <section className="card p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link to="/multijoueur" className="btn-ghost">🎮 Multijoueur</Link>
      ...
      {/* Multijoueur */}
      <section className="card p-6 relative overflow-hidden border border-indigo-500/30">
        <div className="absolute -top-16 -right-16 w-64 h-64 rounded-full bg-indigo-500/10 blur-3xl" />
        <div className="relative flex flex-col md:flex-row md:items-center gap-6">
          <div className="text-6xl">🎮</div>
          <div className="flex-1">
            <h2 className="font-display text-2xl text-white mb-1">Mode Multijoueur</h2>
            <p className="text-slate-300 text-sm">Crée une partie, partage le code à tes amis et affrontez-vous en temps réel sur les mêmes questions !</p>
            <div className="flex flex-wrap gap-2 mt-3">
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded-full">🔗 Parties privées</span>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded-full">👥 Jusqu'à 8 joueurs</span>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded-full">📊 Classement live</span>
            </div>
          </div>
          <div className="flex gap-3 shrink-0">
            <Link to="/multijoueur" className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-5 py-3 rounded-xl transition-all shadow-lg whitespace-nowrap">
              🚀 Jouer ensemble
            </Link>
          </div>
        </div>
