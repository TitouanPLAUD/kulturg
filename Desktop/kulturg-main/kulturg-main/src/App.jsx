...
import MultiplayerHub from './pages/MultiplayerHub.jsx'
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="multijoueur" element={<MultiplayerHub />} />
        <Route path="multijoueur/lobby/:code" element={<Lobby />} />
        <Route path="multijoueur/jeu/:code" element={<MultiplayerGame />} />
        <Route path="multijoueur/resultats/:code" element={<MultiplayerResults />} />
      </Route>
    </Routes>
  )
}
